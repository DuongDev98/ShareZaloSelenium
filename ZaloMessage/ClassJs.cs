...
namespace ZaloMessage
{
    ...
    {
        public const string CONTAINER_MESSAGE = "ReactVirtualized__Grid__innerScrollContainer";
        public const string ITEM_MESSAGE = "msg-item";
        public const string TIN_NHAN_MOI = "fa-num5plus";
